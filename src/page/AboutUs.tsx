...
export default function AboutUs() {
  return (
    <section className="bg-gray-50 py-16 mt-12 px-6">
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-sans underline text-gray-800 mb-2">Our Mission</h3>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-sans text-gray-800 underline mb-2">Our Experience</h3>
            <p className="text-gray-600 font-open-sans">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-sans text-gray-800 underline mb-2">Our Team</h3>
            <p className="text-gray-600 font-open-sans">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-sans text-gray-800 underline mb-2">Our Vision</h3>
            <p className="text-gray-600 font-open-sans">
