...
const SectionLayout: React.FC<AdvancedSectionLayoutProps> = ({
  ...
  return (
    <section className={`px-4 overflow-hidden  bg-slate-600/10 ${sectionTopPadding}`}
    >
      <div
...
<>
          <div className='absolute  h-10 w-[0.5px] left-0 -top-10 sm:-left-0 sm:-top-12 sm:w-[0.5px] sm:h-12  lg:h-14 lg:w-[0.5px] lg:left-0 lg:-top-12   bg-red-200   '></div>
          <div className='absolute  h-10 w-[0.5px] right-0 -top-10 sm:-right-0 sm:-top-12  sm:w-[0.5px] sm:h-12  lg:h-14 lg:w-[0.5px] lg:right-0 lg:-top-12   bg-red-200   '></div>
</>          
        )
        }
